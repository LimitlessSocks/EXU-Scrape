...
CardViewer.monkeyPatchFormat = formatData => {
    if(!CardViewer.BaseFormat.cards) {
        ...
        CardViewer.BaseFormat.isPointed = CardViewer.isPointed;
    }
    let {
        name,
        passcodes,
    ...
    CardViewer.isPointed = !!is_pointed;
        ...
        if(!passcodes || passcodes.some(passcode => passcode == card.serial_number)) {
            if(is_pointed) {
                CardViewer.Database.cards[id] = {
                    ...card,
                    point_limit: +(banlist[card.serial_number] ?? 0),
                };
                delete CardViewer.Database.cards[id].exu_limit;
            }
            else {
                CardViewer.Database.cards[id] = {
                    ...card,
...
CardViewer.restoreBaseFormat = (baseFormat) => {
    ...
    CardViewer.isPointed = baseFormat.isPointed;
};
...
// TODO: don't hardcode
/*
// TODO: filter out rush from scraper
table = [[name, point], [name, point], ...]
.map(([k,v])=>[k.toLowerCase().replace(/\W/g,""),v]);
table=new Map(table);
Object.keys(GenesysPoints).map(key=>{delete GenesysPoints[key]});
Object.values(CardViewer.Database.cards).forEach(card=>{let v=table.get(card.name.toLowerCase().replace(/\W/g,""));if(v)GenesysPoints[card.id]=v;})
*/

/*
list = `...`;

table=list.split("\n").slice(2).map(l=>{k=l.split(" -- ");return[k[1],+k[0].split(" ")[1]];});
missing=[...table].filter(([name,points])=>!CardViewer.getCardByName(name));
if(missing.length)console.error("Missing cards:",missing.map(pair=>pair[0]));
table=new Map(table.map(([name,points])=>[name.toLowerCase().replace(/\W/g,""),points]));
Object.keys(GenesysPoints).map(key=>{delete GenesysPoints[key]});
Object.values(CardViewer.Database.cards).forEach(card=>{let v=table.get(card.name.toLowerCase().replace(/\W/g,""));if(v)GenesysPoints[card.id]=v+"";})
copy(JSON.stringify(GenesysPoints).replace("{","{\n    ").replace("}", "\n}"));
*/
const GenesysPoints = {
    "82":"5","175":"100","185":"100","188":"50","209":"100","226":"100","328":"70","329":"70","330":"70","331":"70","332":"70","333":"70","419":"51","470":"13","486":"70","526":"3","528":"4","549":"100","562":"3","589":"1","612":"40","620":"33","630":"100","654":"50","662":"6","680":"25","742":"100","758":"100","800":"1","864":"33","884":"27","914":"1","917":"51","980":"100","989":"1","1039":"5","1074":"100","1091":"100","1096":"1","1138":"20","1168":"10","1174":"40","1207":"100","1300":"20","1319":"51","1340":"8","1432":"35","1467":"100","1468":"1","1559":"30","1578":"100","1602":"33","1647":"33","1651":"5","1653":"3","1673":"33","1674":"100","1752":"100","1852":"40","1873":"1","1884":"91","1916":"21","1940":"10","1960":"100","1961":"40","2102":"9","2113":"100","2116":"6","2210":"100","2219":"100","2243":"88","2272":"100","2280":"7","2330":"100","2382":"100","2450":"75","2453":"3","2461":"3","2468":"3","2512":"100","2513":"100","2551":"10","2563":"100","2575":"100","2578":"1","2620":"33","2685":"75","2694":"95","2758":"1","2784":"100","2797":"50","2855":"5","2878":"1","2951":"50","2952":"4","2966":"33","3055":"10","3057":"50","3065":"100","3097":"40","3204":"3","3212":"91","3249":"95","3346":"30","3364":"100","3367":"3","3368":"5","3382":"100","3389":"3","3390":"61","3433":"11","3460":"4","3498":"50","3533":"33","3571":"40","3574":"100","3609":"100","3633":"60","3644":"10","3650":"100","3651":"100","3754":"100","3764":"100","3767":"1","3805":"33","3840":"100","3856":"65","3859":"100","3895":"87","3902":"4","3913":"7","3914":"5","3962":"20","4088":"60","4092":"100","4108":"13","4137":"33","4191":"33","4217":"100","4235":"33","4290":"100","4309":"100","4349":"100","4384":"20","4420":"7","4432":"3","4436":"5","4443":"94","4476":"13","4532":"100","4574":"7","4597":"100","4598":"100","4599":"100","4